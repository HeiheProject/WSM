...
namespace WatershedIntegratedModel
{
    public class Ecohydro_socioeco_Integrated_model
    {
        ...
        private void InitBaseValue()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(err.Message, "Initialize base value of hydrological model of upstream");
            }
        }
        ...
        private void InitWateruseCoeff()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(err.Message, "Initialize water use coefficient");
            }
        }
        ...
        private double[, ,] ReadResultEcoModel(string fullpath)
        {
            try
            {
                ...
                {
                    MessageBox.Show("The system cannot find the result.xls file!", "读取经济模型输出文件result");
                }
                return _res;
            }
            catch (Exception err)
        ...
        private double[, ,] ReadPercentEcoModel(string fullpath)
        {
            try
            {
                ...
                {
                    MessageBox.Show("The system cannot find the result.xls file!", "读取经济模型输出文件percent");
                }
                return _res;
            }
            catch (Exception err)
